...
> [!note]
> The newer version of the class still requires an update of this `README` file. Whenever the new class will be somewhat ready for being delivered to the `main` branch, an update of this file will be committed. For all the documentation, please refer to the [documentation PDF](https://github.com/ElBi21/NoTeX/blob/dev/main.pdf)
